#!/usr/bin/env python3
"""
Simple script to upload RTI PDFs with clean text extraction
This version works from the root directory without complex imports
"""
